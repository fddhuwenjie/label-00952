...
$routes = [
    ...
    'GET /api/v1/dashboard/account-sales-rank' => ['App\Controllers\DashboardController', 'accountSalesRank'],
    'GET /api/v1/dashboard/hourly-orders' => ['App\Controllers\DashboardController', 'hourlyOrders'],
